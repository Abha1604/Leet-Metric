...
![Result View](screenshots/ss_Input.png)

### Empty Input validation
![Empty Input](screenshots/ss_EmptyField.png)

### Invalid Username format
![Invalid Username](screenshots/ss_Invalid.png)

### User not found
![User not found](screenshots/ss_NOTFound.png)
